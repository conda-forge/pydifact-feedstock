...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pydifact-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10778&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pydifact-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pydifact` can be installed with:

```
conda install pydifact
```

It is possible to list all of the versions of `pydifact` available on your platform with:
